 ...
 *
 * Single source of truth for all course documents + the Guia dos Documentos models.
...
// Modelos usados pelo Guia dos Documentos — "free" durante a fase de demonstração.
// Rever o tier no lançamento comercial (ver decisão: só diagnósticos ficam no plano gratuito).
export const DOCS_CATALOG: CourseDoc[] = [
  ...
  // ── Aula 1.3 ────────────────────────────────────────────────────────────────
  { id: "m1a3-01", lessonId: "1.3", filename: "NIS2_Dashboard_KPIs_Governanca.xlsx",                label: "Dashboard de KPIs de Governança",            type: "xlsx", plan: "free" },
  ...
  { id: "m1a3-04", lessonId: "1.3", filename: "NIS2_Ata_Reuniao_Ciberseguranca_EDITAVEL.pdf",       label: "Ata de Reunião de Cibersegurança (editável)",type: "pdf",  plan: "free" },
  ...
  // ── Aula 1.4 ────────────────────────────────────────────────────────────────
  { id: "m1a4-01", lessonId: "1.4", filename: "NIS2_Exit_Strategy_Fornecedores.xlsx",               label: "Exit Strategy de Fornecedores Críticos",     type: "xlsx", plan: "free" },
  { id: "m1a4-02", lessonId: "1.4", filename: "NIS2_Inventario_Fornecedores_TPRM.xlsx",             label: "Inventário de Fornecedores TPRM",            type: "xlsx", plan: "free" },
  { id: "m1a4-03", lessonId: "1.4", filename: "NIS2_Template_Clausulas_Contratos.docx",             label: "Template Cláusulas NIS2 para Contratos",     type: "docx", plan: "free" },
  { id: "m1a4-04", lessonId: "1.4", filename: "NIS2_Questionario_Due_Diligence_Fornecedores_EDITAVEL.pdf", label: "Questionário Due Diligence Fornecedores", type: "pdf", plan: "free" },
  ...
  // ── Aula 2.1 ────────────────────────────────────────────────────────────────
  { id: "m2a1-01", lessonId: "2.1", filename: "NIS2_Calculadora_RTO_RPO_Backup.xlsx",               label: "Calculadora RTO/RPO de Backup",              type: "xlsx", plan: "free" },
  ...
  // ── Aula 2.2 ────────────────────────────────────────────────────────────────
  { id: "m2a2-01", lessonId: "2.2", filename: "NIS2_Log_Incidentes_Ciberseguranca.xlsx",            label: "Log de Incidentes com Dashboard",            type: "xlsx", plan: "free" },
  ...
  // ── Guia dos Documentos (/guia-documentos) — modelos sem aula de curso associada ──
  // Fase de testes: "free" para todos. Rever tier quando a plataforma sair de demo.
  { id: "guia-01", lessonId: "guia", filename: "NIS2_Teste_Backup_RTO_Medido.xlsx",     label: "Teste de Backup e RTO Medido",              type: "xlsx", plan: "free" },
