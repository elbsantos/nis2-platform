...
function AppNav() {
  ...
  const inactive = `${base} text-gray-300 hover:bg-[#152744] hover:text-white`;

  return (
    <nav className="bg-[#0f1e38] border-b border-[#1f3864] px-4">
      <div className="max-w-5xl mx-auto flex items-center gap-1 h-12">
        <NavLink to="/" className="font-bold text-[#f0c040] text-sm mr-4 hover:text-[#d4a017]">
          CISPLAN
        </NavLink>
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <button
            ...
            className="text-xs text-gray-400 hover:text-white px-2 py-1 rounded hover:bg-[#1f3864] transition-colors"
          >
            Sair
          </button>
        </div>
