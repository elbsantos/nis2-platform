...
export default function Landing() {
  ...
  return (
    <div className="lp-page">
      ...
      {/* NAV */}
      <nav>
        <div className="nav-logo">CISPLAN</div>
      ...
      <section className="pricing" id="pricing">
        ...
        <div className="pricing-grid fade-in">
          ...
          <div className="price-card">
            ...
            <h3>Personalizado</h3>
            <p className="tagline">Para organismos públicos, grupos empresariais e necessidades de conformidade à medida.</p>
            <div className="price-amount">
              <span className="value" style={{ fontSize: "1.4rem" }}>Fale connosco</span>
              <div className="period">proposta personalizada</div>
            </div>
            <ul className="price-features">
              <li className="yes">Tudo do plano MSSP</li>
              <li className="yes">Contrato anual (2 meses grátis)</li>
              <li className="yes">SLA de suporte dedicado</li>
              <li className="yes">Formação in-house incluída</li>
              <li className="yes">Integração com SIEM / GRC</li>
              <li className="yes">Auditoria assistida CNCS</li>
            </ul>
            <a href="mailto:hello@cisplan.pt?subject=Plano Enterprise CISPLAN" className="price-btn outline">Contactar equipa →</a>
          </div>
        </div>
      ...
      {/* FOOTER */}
      <footer>
        <div className="footer-logo">CISPLAN</div>
