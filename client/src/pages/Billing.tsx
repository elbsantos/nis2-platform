  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 items-start">
        ...
        {/* Enterprise card */}
        <div className="relative flex flex-col bg-white border border-gray-200 rounded-2xl p-6">
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-500 mt-1">Para organismos públicos, grupos empresariais e contratos anuais.</p>
          </div>
          <ul className="space-y-2 flex-1 mb-6">
            {[
              "Tudo do plano MSSP",
              "Contrato anual (2 meses grátis)",
              "SLA de suporte dedicado",
              "Formação in-house incluída",
              "Integração com SIEM / GRC",
              "Auditoria assistida CNCS",
            ].map((f) => (
              <li key={f} className="flex items-start gap-2 text-sm text-gray-700">
                <Check />
                <span>{f}</span>
          ...
          <a
            href="mailto:hello@cisplan.pt?subject=Plano Enterprise CISPLAN"
            className="w-full py-2.5 rounded-lg text-sm font-medium text-center border border-gray-300 text-gray-700 hover:bg-gray-50 block"
          >
            Contactar equipa →
          </a>
        </div>
